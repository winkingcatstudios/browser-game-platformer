...
export default class FrogController {
    ...
    constructor(
        ...
        sprite: Phaser.Physics.Matter.Sprite
            ...
            events.on('frog-stomped', this.handleStomped, this);
        }

        // clean up events
        destroy() {
            events.off('frog-stomped', this.handleStomped, this);
        }
        ...
        private createAnims() {
            this.sprite.anims.create( {
                key: 'idle',
                frames: [{ key: 'frog', frame: 'frog.png' }]
            });
            this.sprite.anims.create( {
                key: 'move-left',
                frameRate: 5,
                frames: [{ key: 'frog', frame: 'frog.png' }, { key: 'frog', frame: 'frog_move.png' }],
                repeat: -1
            });
            this.sprite.anims.create( {
                key: 'move-right',
